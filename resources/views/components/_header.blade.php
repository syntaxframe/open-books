      ...
      <div class="flex gap-3 items-center">
        @auth
          @if(Auth::user()->hasRole(DB::table('roles')->select('key')->whereRaw("LEFT(`key`, 3) = 'ADM'")->get()))
            <a href="/book/add" class="flex items-center gap-2 bg-emerald-500 border border-emerald-500 text-white rounded-xl block px-3 py-2">
